...
class ModulusReduceContextOp : public OpKernel {
 ...
 public:
  ...
  void Compute(OpKernelContext* op_ctx) override {
    ...
    OP_REQUIRES_OK(op_ctx, context_var_reduced.Initialize(
                               context_var->log_n_, reduced_qs,
                               context_var->ps_, context_var->pt_modulus_,
                               context_var->noise_variance_, context_var->seed_));
