...
def to_shell_plaintext(tensor, context, override_scaling_factor=None, randomized_rounding_override=None):
    ...
    if isinstance(tensor, ShellTensor64):
        ...
        return ShellTensor64(
            _raw_tensor=shell_ops.polynomial_import64(
                ...
                random_round= randomized_rounding_override if randomized_rounding_override is not None else _ENALBE_RANDOMIZED_ROUNDING,
            ),
            _context=context,
