            ...
            if self.noise_multiplier > 0.0:
                if self.simple_noise_INSECURE:
                    ...
                    if self.disable_he_backprop_INSECURE:
                        ...
                        clipping_scaling_factors = tf.minimum(clipping_scaling_factors, backprop_context.scaling_factor**2)
                        clipping_scaling_factors = tf.maximum(clipping_scaling_factors, 4.)
                        ...
                        # stated.
                        rounded_clippers = [tf_shell.smallest_case_rounding(clipper, g._scaling_factor) for g in grads]
                        rounded_clippers = [tf_shell.to_shell_plaintext(
                            rc, 
                            backprop_context, 
